...
/**
 * Class RoslynInstagramHelper
 */
class RoslynInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines roslyn_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'roslyn_instagram_image_atts',
			array(
