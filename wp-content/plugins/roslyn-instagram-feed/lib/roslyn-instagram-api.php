...
include 'roslyn-instagram-helper.php';

/**
 * Class RoslynInstagramApi
 */
class RoslynInstagramApi {
	...
	const INSTAGRAM_CODE = 'roslyn_instagram_code';
	const INSTAGRAM_USER_ID = 'roslyn_instagram_user_id';
	const INSTAGRAM_TOKEN = 'roslyn_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'roslyn_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'roslyn_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'roslyn_facebook_code';
	const FACEBOOK_TOKEN = 'roslyn_facebook_access_token';

	const CONNECTION_TYPE = 'roslyn_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new RoslynInstagramHelper();
	}

	/**
	 * @return RoslynInstagramApi
	 */
	 ...
	 *
	 * @see RoslynInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see RoslynInstagramApi::instagramExchangeCodeForToken()
	 */
