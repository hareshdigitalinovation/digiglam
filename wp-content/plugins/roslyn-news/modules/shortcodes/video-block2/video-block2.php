...
namespace RoslynNews\CPT\Shortcodes\VideoBlock2;

use RoslynNews\Lib;

class VideoBlock2 extends Lib\NewsShortcodes {
	private $base;
	private $css_class;
	...
	function __construct() {
		$this->base            = 'eltdf_video_block2';
		$this->css_class       = 'eltdf-video-block2';
		$this->shortcode_title = esc_html__( 'Video Block 2', 'roslyn-news' );
		$this->icon_class      = 'video-block2';
	...
	public function getAdditionalHolderClasses($params){
		$classes = array();
		$classes[] = 'eltdf-news-block-pp-full-width';
