...
namespace RoslynNews\CPT\Shortcodes\Layout6;
...
class Layout6 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'eltdf_layout6';
		$this->css_class       = 'eltdf-layout6';
		$this->shortcode_title = esc_html__( 'Layout 6', 'roslyn-news' );
	...
	public function render( $atts, $content = null ) {
		...
		$html = roslyn_news_get_shortcode_module_template_part( 'templates/layout6-template', 'layout6', '', $params );
