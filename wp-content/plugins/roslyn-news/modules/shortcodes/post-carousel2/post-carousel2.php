...
namespace RoslynNews\CPT\Shortcodes\PostCarousel2;
...
class PostCarousel2 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'eltdf_post_carousel2';
		$this->css_class       = 'eltdf-post-carousel2';
		$this->shortcode_title = esc_html__( 'Post Carousel 2', 'roslyn-news' );
