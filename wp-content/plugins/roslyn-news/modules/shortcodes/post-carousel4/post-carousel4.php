...
namespace RoslynNews\CPT\Shortcodes\PostCarousel4;
...
class PostCarousel4 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'eltdf_post_carousel4';
		$this->css_class       = 'eltdf-post-carousel4';
		$this->shortcode_title = esc_html__( 'Post Carousel 4', 'roslyn-news' );
