...
(function ($) {
    ...
    Select.prototype = {
        ...
        setSize: function (size) {
            ...
            $('body').append($option);
            height = $option.outerHeight(true) * 2;
            $option.remove();
    ...
    Option.prototype = {
        ...
        setWidth: function () {
            if (this.wSelect.multiple || this.wSelect.widthSet) {
                return true;
            }
            ...
            var elements = this.each(function () {
                ...
                if (wSelect) {
                    ...
                    if (wSelect[options]) {
                        ...
                        if (wSelect[func]) {
                            wSelect[func].apply(wSelect, [value]);
                        }
                        if (wSelect.options[options]) {
                            wSelect.options[options] = value;
                        }
                    } else {
                        if (wSelect[func]) {
                            values.push(wSelect[func].apply(wSelect, [value]));
                        } else if (wSelect.options[options]) {
                            values.push(wSelect.options[options]);
                        } else {
                            values.push(null);
                        }
                    }
