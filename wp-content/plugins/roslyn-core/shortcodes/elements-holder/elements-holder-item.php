...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'roslyn-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'roslyn-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'roslyn-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'roslyn-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'roslyn-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1366px-1600px', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'roslyn-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'roslyn-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1024_1366',
							'heading'     => esc_html__( 'Padding on screen size between 1024px-1366px', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'roslyn-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'roslyn-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'roslyn-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'roslyn-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'roslyn-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'roslyn-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'roslyn-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'roslyn-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = roslyn_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
