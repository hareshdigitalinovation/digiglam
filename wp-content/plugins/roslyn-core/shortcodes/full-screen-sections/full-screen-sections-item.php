<?php
namespace RoslynCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'roslyn-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'roslyn-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'roslyn-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'roslyn-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'roslyn-core' )   => 'cover',
								esc_html__( 'Contain', 'roslyn-core' ) => 'contain',
								esc_html__( 'Inherit', 'roslyn-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Content Vertical Alignment', 'roslyn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'roslyn-core' ) => '',
								esc_html__( 'Top', 'roslyn-core' )     => 'top',
								esc_html__( 'Middle', 'roslyn-core' )  => 'middle',
								esc_html__( 'Bottom', 'roslyn-core' )  => 'bottom'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'roslyn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'roslyn-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'roslyn-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'roslyn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'roslyn-core' ) => '',
								esc_html__( 'Light', 'roslyn-core' )   => 'light',
								esc_html__( 'Dark', 'roslyn-core' )    => 'dark'
							),
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'roslyn-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'roslyn-core'),
							'group'       => esc_html__('Responsiveness', 'roslyn-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'roslyn-core'),
							'group'       => esc_html__('Responsiveness', 'roslyn-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'roslyn-core'),
							'group'       => esc_html__('Responsiveness', 'roslyn-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'roslyn-core'),
							'group'       => esc_html__('Responsiveness', 'roslyn-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = roslyn_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
