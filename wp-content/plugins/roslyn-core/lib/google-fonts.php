<?php
if ( ! function_exists( 'roslyn_elated_init_google_fonts_array' ) ) {
    function roslyn_elated_init_google_fonts_array() {
        ...
        $roslyn_elated_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'roslyn_elated_init_google_fonts_array');
}