...
class RoslynElatedBlogListWidget extends RoslynElatedWidget {
	public function __construct() {
		parent::__construct(
			'eltdf_blog_list_widget',
			esc_html__( 'Roslyn Blog List Widget', 'roslyn' ),
			array( 'description' => esc_html__( 'Display a list of your blog posts', 'roslyn' ) )
		);
		...
		$this->params = array(
			...
			array(
				...
				'options' => array(
					...
					'minimal' => esc_html__( 'Minimal', 'roslyn' )
				)
			),
			array(
				'type'  => 'textfield',
				'name'  => 'number_of_posts',
				'title' => esc_html__( 'Number of Posts', 'roslyn' )
			),
			array(
				'type'    => 'dropdown',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'orderby',
				'title'   => esc_html__( 'Order By', 'roslyn' ),
				'options' => roslyn_elated_get_query_order_by_array()
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'order',
				'title'   => esc_html__( 'Order', 'roslyn' ),
				'options' => roslyn_elated_get_query_order_array()
			),
			array(
				'type'        => 'textfield',
				'name'        => 'category',
				'title'       => esc_html__( 'Category Slug', 'roslyn' ),
				'description' => esc_html__( 'Leave empty for all or use comma for list', 'roslyn' )
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'title_tag',
			...
			array(
				...
				'title'   => esc_html__( 'Title Text Transform', 'roslyn' ),
