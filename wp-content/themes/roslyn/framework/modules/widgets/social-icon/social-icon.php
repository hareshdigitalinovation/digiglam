...
class RoslynElatedSocialIconWidget extends RoslynElatedWidget {
	
	public function __construct() {
		parent::__construct(
			'eltdf_social_icon_widget',
			esc_html__( 'Roslyn Social Icon Widget', 'roslyn' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'roslyn' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			roslyn_elated_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="eltdf-social-icon-widget-holder eltdf-icon-has-hover" <?php echo roslyn_elated_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php roslyn_elated_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
