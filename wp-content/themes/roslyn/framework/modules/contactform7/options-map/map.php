...
if ( ! function_exists('roslyn_elated_contact_form_7_options_map') ) {

	function roslyn_elated_contact_form_7_options_map() {
		
		roslyn_elated_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'roslyn' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = roslyn_elated_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'roslyn' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'roslyn' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'roslyn' ),
			)
		);
		...
		$typography_text_row2 = roslyn_elated_add_admin_row(
			array(
		...
		$typography_text_row3 = roslyn_elated_add_admin_row(
			array(
		...
		$typography_label_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'roslyn' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = roslyn_elated_add_admin_row(
			array(
		...
		$typography_label_row2 = roslyn_elated_add_admin_row(
			array(
		...
		$background_border_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'roslyn' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'roslyn' )
			)
		);
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'roslyn' )
			)
		);
		
		$background_border_row2 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'roslyn' ),
			)
		);
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'roslyn' )
			)
		);
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'roslyn' )
			)
		);
		
		$background_border_row3 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'roslyn' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = roslyn_elated_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'roslyn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'roslyn' ),
				'description' => esc_html__( 'Setup form elements margin', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = roslyn_elated_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'roslyn' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'roslyn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'roslyn' ),
				'description' => esc_html__( 'Setup button text typography', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Hover Text Color', 'roslyn' )
			)
		);
		...
		$button_typography_row2 = roslyn_elated_add_admin_row(
			array(
		...
		$button_background_border_group = roslyn_elated_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'roslyn' ),
				'description' => esc_html__( 'Setup button background and border style', 'roslyn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'roslyn' )
			)
		);
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'roslyn' )
			)
		);
		
		$button_background_border_row2 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'roslyn' )
			)
		);
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'roslyn' )
			)
		);
		
		$button_background_border_row3 = roslyn_elated_add_admin_row(
			array(
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'roslyn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		roslyn_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'roslyn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = roslyn_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'roslyn')
		));

		//Text Typography

		$typography_text_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'roslyn'),
			'description'	=> esc_html__('Setup typography for form elements text', 'roslyn'),
		...
		$typography_text_row1 = roslyn_elated_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = roslyn_elated_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = roslyn_elated_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'roslyn'),
			'description'	=> esc_html__('Setup typography for form elements label', 'roslyn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = roslyn_elated_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = roslyn_elated_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'roslyn'),
			'description'	=> esc_html__('Setup form elements background and border style', 'roslyn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = roslyn_elated_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = roslyn_elated_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = roslyn_elated_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'roslyn'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = roslyn_elated_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'roslyn'),
			'description'	=> esc_html__('Setup form elements margin', 'roslyn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = roslyn_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'roslyn'),
			'description'	=> esc_html__('Setup button text typography', 'roslyn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = roslyn_elated_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = roslyn_elated_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = roslyn_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'roslyn'),
			'description'	=> esc_html__('Setup button background and border style', 'roslyn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = roslyn_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = roslyn_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = roslyn_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = roslyn_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'roslyn')
        ));
        ...
        $typography_label_row3 = roslyn_elated_add_admin_row(array(
        ...
        $button_typography_row3 = roslyn_elated_add_admin_row(array(
	...
	add_action( 'roslyn_elated_options_map', 'roslyn_elated_contact_form_7_options_map', 20);
}