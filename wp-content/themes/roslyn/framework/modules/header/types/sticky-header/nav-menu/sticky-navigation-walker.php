...
if (!class_exists('RoslynElatedStickyNavigationWalker')) {
	class RoslynElatedStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($depth==0){
				if($item->type_menu == "wide") {
					...
					$menu_type = " wide eltdf-menu-custom-widget";
				} elseif ($item->type_menu == "wide_3_cols"){
					$menu_type = " wide eltdf-menu-3-columns";
				} else {
					$menu_type = " narrow";
				}
			}
