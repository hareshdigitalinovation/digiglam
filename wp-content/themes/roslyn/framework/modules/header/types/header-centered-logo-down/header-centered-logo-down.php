...
/**
 * Class that represents Header Centered Logo Down layout and option
 *
 * Class HeaderCenteredLogoDown
 */
class HeaderCenteredLogoDown extends HeaderType {
	...
	public function __construct() {
		$this->slug = 'header-centered-logo-down';
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters = apply_filters( 'roslyn_elated_header_centered_logo_down_parameters', $parameters );
