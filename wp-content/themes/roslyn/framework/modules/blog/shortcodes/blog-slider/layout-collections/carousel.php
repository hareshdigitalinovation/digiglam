	...
	<div class="eltdf-blog-slider-item-inner">
		...
		<div class="eltdf-bli-content">
			...
			<div class="eltdf-bli-excerpt">
				<?php roslyn_elated_get_module_template_part( 'templates/parts/excerpt', 'blog', '', $params ); ?>
				<?php roslyn_elated_get_module_template_part( 'templates/parts/post-info/read-more', 'blog', '', $params ); ?>
			</div>
		</div>
	</div>
</li>