...
if ( ! function_exists( 'roslyn_elated_add_simple_line_icon_pack' ) ) {
	function roslyn_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new RoslynElatedSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_simple_line_icon_pack_option' ) ) {
	function roslyn_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_simple_line_icon_pack_option' );
	add_filter( 'roslyn_elated_add_icon_pack_into_social_options', 'roslyn_elated_add_simple_line_icon_pack_option' );
}

class RoslynElatedSimpleLineIcons implements iRoslynElatedIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'roslyn'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'roslyn'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'roslyn'),
            'icon-social-facebook'    => esc_html__('Facebook', 'roslyn'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'roslyn'),
            'icon-social-github'      => esc_html__('Github', 'roslyn'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'roslyn'),
            'icon-social-instagram'   => esc_html__('Instagram', 'roslyn'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'roslyn'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'roslyn'),
            'icon-social-reddit'      => esc_html__('Reddit', 'roslyn'),
            'icon-social-skype'       => esc_html__('Skype', 'roslyn'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'roslyn'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'roslyn'),
            'icon-social-spotify'     => esc_html__('Spotify', 'roslyn'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'roslyn'),
            'icon-social-twitter'     => esc_html__('Twitter', 'roslyn'),
            'icon-social-youtube'     => esc_html__('Youtube', 'roslyn')
        );
    }
