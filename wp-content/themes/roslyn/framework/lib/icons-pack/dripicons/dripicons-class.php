...
if ( ! function_exists( 'roslyn_elated_add_dripicons_icon_pack' ) ) {
	function roslyn_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new RoslynElatedDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_dripicons_icon_pack_option' ) ) {
	function roslyn_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_dripicons_icon_pack_option' );
}

class RoslynElatedDripicons implements iRoslynElatedIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
