...
if ( ! function_exists( 'roslyn_elated_add_linear_icon_pack' ) ) {
	function roslyn_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new RoslynElatedLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_linear_icon_pack_option' ) ) {
	function roslyn_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_linear_icon_pack_option' );
}

class RoslynElatedLinearIcons implements iRoslynElatedIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
