...
if ( ! function_exists( 'roslyn_elated_add_font_elegant_icon_pack' ) ) {
	function roslyn_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new RoslynElatedIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_font_elegant_icon_pack_option' ) ) {
	function roslyn_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'roslyn_elated_add_icon_pack_into_social_options', 'roslyn_elated_add_font_elegant_icon_pack_option' );
}

class RoslynElatedIconsFontElegant implements iRoslynElatedIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
