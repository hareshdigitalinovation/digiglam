...
if ( ! function_exists( 'roslyn_elated_add_ion_icon_pack' ) ) {
	function roslyn_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new RoslynElatedIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_ion_icon_pack_option' ) ) {
	function roslyn_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_ion_icon_pack_option' );
	add_filter( 'roslyn_elated_add_icon_pack_into_social_options', 'roslyn_elated_add_ion_icon_pack_option' );
}

class RoslynElatedIonIcons implements iRoslynElatedIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
