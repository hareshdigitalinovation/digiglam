...
if ( ! function_exists( 'roslyn_elated_add_linea_icon_pack' ) ) {
	function roslyn_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new RoslynElatedLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_collection', 'roslyn_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'roslyn_elated_add_linea_icon_pack_option' ) ) {
	function roslyn_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'roslyn' );
		
		return $options;
	}
	
	add_filter( 'roslyn_elated_add_icon_pack_into_options', 'roslyn_elated_add_linea_icon_pack_option' );
}

class RoslynElatedLineaIcons implements iRoslynElatedIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
